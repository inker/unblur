...
var fixMutated = function (mutations) { return fixBlurry(mutations.map(function (m) { return m.target; })); };
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (options) {
    if (options === void 0) { options = {}; }
    var newOptions = __assign({}, defaultUnblurOptions, options);
    var interval = newOptions.interval, element = newOptions.element, skipWhen = newOptions.skipWhen;
    var throttledCallback = lodash_1.throttle(fixMutated, interval);
